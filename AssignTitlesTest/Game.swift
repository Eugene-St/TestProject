...
struct Game
{
    ...
    let question1 = Question(question: "Four stories about a honey-loving bear and his friends", answerChoices: ["Dumbo", "Bolt", "Oliver and Company", "The many adventures of Winnie the Pooh"], correctAnswer: "The many adventures of Winnie the Pooh")
    ...
    let question5 = Question(question: "A mean and wealthy woman goes a long way to get a fur coat", answerChoices: ["The Emperor's New Groove", "Show WHite and the Sever Dwarfs", "One Hundred and One Dalmatians", "Beauty and the Beast"], correctAnswer: "One Hundred and One Dalmatians")
    ...
    let question7 = Question(question: "The arrival of a new birthday present leads to jealousy and adventures while moving to a new house", answerChoices: ["Toy Story", "Finding Nemo", "The Aristocats", "The Many Adventures of Winnie the Pooh"], correctAnswer: "Toy Story")
    ...
    let question10 = Question(question: "A teenage princess is tricked to touch an enchanted spinning wheel", answerChoices: ["Sleeping Beauty", "Cinderella", "Snow White and the Seven Dwarfs", "Tangled"], correctAnswer: "Sleeping Beauty")
 ...
 selectedIndex = GKRandomSource.sharedRandom().nextInt(upperBound: questions.count)
        ...
        */
        ...
        repeat {
            selectedIndex = GKRandomSource.sharedRandom().nextInt(upperBound: questions.count)
        } while questions.count == selectedIndex
